...
import { CheckIcon, Moon, MoonIcon, Sun, SunIcon, XIcon } from 'lucide-react';
...
const DarkModeSwitch = () => {
    ...
    return (
        <div>
            <div className='fixed right-10 bottom-10 inline-grid h-7 grid-cols-[1fr_1fr] items-center text-sm font-medium'>
                <Switch
                    checked={checked}
