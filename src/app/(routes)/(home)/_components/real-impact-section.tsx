...
const RealImpactSection = () => {
    return (
        <section className='relative min-h-screen overflow-hidden bg-slate-900 py-16'>
            ...
            <div className='container'>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div
                        className='flex flex-col gap-4 rounded-3xl border border-teal-600/30 p-6 backdrop-blur-sm transition-all duration-300 hover:opacity-90 md:p-8 lg:col-span-2 lg:flex-row lg:items-center lg:gap-8'
                        style={{ background: 'linear-gradient(221.88deg, #50A8B9 -34.4%, #357784 52.15%)' }}>
                        <Image src='/icons/ic-thumb.png' alt='icons' width={42} height={42} />
                        <div className='flex flex-col items-start gap-2'>
                            <h2 className='mb-2 text-4xl font-extrabold text-white'>120+</h2>
                    ...
                    {/* Riset Statistik */}
                    <div
                        className='flex flex-col justify-between rounded-3xl border border-teal-600/30 bg-teal-600/40 p-6 backdrop-blur-sm transition-all duration-300 hover:opacity-90 md:p-8 lg:row-span-2'
                        style={{ background: 'linear-gradient(221.88deg, #50A8B9 -34.4%, #357784 52.15%)' }}>
                        <div className='flex flex-col gap-2'>
                            <Image src='/icons/ic-chart.png' alt='icons' width={42} height={42} />
                            <h2 className='mt-4 text-4xl font-extrabold text-white lg:mt-6'>40+</h2>
                    ...
                    {/* Provinsi Dijangkau */}
                    <div
                        className='rounded-3xl border border-teal-600/30 bg-teal-600/40 p-6 backdrop-blur-sm transition-all duration-300 hover:opacity-90 md:p-8'
                        style={{ background: 'linear-gradient(221.88deg, #50A8B9 -34.4%, #357784 52.15%)' }}>
                        <Image src='/icons/ic-globe.png' alt='icons' width={42} height={42} className='h-auto w-auto' />

                        <h2 className='my-4 text-4xl font-extrabold text-white'>20+</h2>
                        <div className='space-y-1'>
                    ...
                    {/* Organisasi Anggota */}
                    <div
                        className='rounded-3xl border border-teal-600/30 p-6 backdrop-blur-sm transition-all duration-300 hover:opacity-90 md:p-8'
                        style={{ background: 'linear-gradient(221.88deg, #50A8B9 -34.4%, #357784 52.15%)' }}>
                        <Image src='/icons/ic-people.png' alt='icons' width={42} height={42} />

                        <h2 className='my-4 text-4xl font-extrabold text-white'>80+</h2>
                        <div className='space-y-1'>
