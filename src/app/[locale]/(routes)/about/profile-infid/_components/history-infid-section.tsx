...
import {
  ...
  LeadershipTimeline,
  Publication,
} from "@/types/leadership-timeline";
...
const InfidTimeline = ({
  ...
  initialData: LeadershipTimeline[];
}) => {
  ...
  const [activeTimelineId, setActiveTimelineId] = useState<number>(
    initialData[0].id,
  );
  const [selectedTimeline, setSelectedTimeline] = useState<LeadershipTimeline>(
    initialData[0],
  );
  ...
  return (
    <section
      className="from-secondary-100 min-h-screen bg-linear-to-b to-transparent pt-24"
      id="history-infid"
    >
            ...
            <div className="max-w-full xl:max-w-4xl">
              ...
              <div className="flex flex-col items-start gap-8 md:flex-row">
                ...
                <div className="w-full md:w-3/4">
                  <ArticleContent
                    content={
                      selectedTimeline.description[langIndex]?.text ?? ""
                    }
                  />
                </div>
              </div>
