                        ...
                        <div className='flex-1 space-y-6'>
                            ...
                            <div className='flex gap-4'>
                                ...
                                <Button
                                    variant='outline'
                                    asChild
                                    className='border-primary-500 w-fit rounded-full transition-all focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:outline-none'>
                                    <Link href='/contact-us'>{t('buttons.contact')}</Link>
                                </Button>
                            </div>
                        </div>
                    </div>
