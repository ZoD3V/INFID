...
const RealImpactSection = ({ programData }: { programData: Post[] }) => {
  ...
  const getTranslation = (item: Post, targetLang: string) => {
    ...
    return (
      item.translations.find((t) => t.language === targetLang) ||
      item.translations[0]
    );
  };
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-12">
          ...
          <Dialog>
                ...
                <div className="flex items-start gap-4 px-1 pb-2 lg:px-4">
                  ...
                  <div className="flex flex-col pb-2 lg:pb-0">
                    ...
                    <p className="mb-2 text-sm leading-relaxed text-slate-600">
                      Memastikan ketersediaan dan pengelolaan air bersih dan
                      sanitasi yang berkelanjutan merupakan tujuan ke-6 dari
                      Tujuan Pembangunan Berkelanjutan (TPB/SDGs). Sayangnya,
                      penyediaan akses terhadap air bersih dan fasilitas
                      sanitasi di Indonesia dalam praktiknya belum optimal,
                      salah satunya yang ditemukan di pesantren.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <DialogContent className="max-w-[calc(100%-2rem)] overflow-hidden border-none bg-black p-0 md:max-w-184 [&>button]:hidden">
              <VisuallyHidden>
                <DialogHeader>
                  <DialogTitle>
                    Video Perjalanan SDGs Tangerang - INFID
                  </DialogTitle>
                </DialogHeader>
              </VisuallyHidden>
            ...
            <div
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ")
                  handleArticleClick(programData[0]);
              }}
          ...
          {!programData[1] ? (
            ...
            <div
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ")
                  handleArticleClick(programData[1]);
              }}
            ...
            >
              ...
              <div className="px-1 pb-2">
                ...
                <div className="space-y-3">
                  <h3
                    id="card-title-riset"
                    className="group-hover:text-primary-500 line-clamp-2 text-base font-bold lg:text-lg"
                  >
          ...
          {!programData[2] ? (
            ...
            <div
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ")
                  handleArticleClick(programData[2]);
              }}
              className="group col-span-1 flex cursor-pointer flex-col rounded-xl border border-slate-200 bg-white p-2 backdrop-blur-sm transition-all duration-300 outline-none hover:shadow-md md:col-span-6 lg:col-span-4"
            >
              <Image
          ...
          <div className="order bg-secondary-100 col-span-1 flex flex-col items-center justify-between gap-4 overflow-hidden rounded-xl border border-slate-200 backdrop-blur-sm transition-all duration-300 hover:shadow-md md:col-span-6 lg:col-span-4">
            <Image
            ...
            <div className="px-5 pb-5 lg:pt-0">
              <div className="space-y-2 lg:space-y-4">
                ...
                <p className="max-w-3xl text-sm text-slate-700">
                  {c("impactCardDescription")}
                </p>
                <Button className="w-full rounded-full bg-primary-600 hover:bg-primary-700 text-white">
                  {b("readAllStories")}
                </Button>
              </div>
            </div>
...
const CardSkeleton = ({ className }: { className?: string }) => (
  ...
  >
    <div className="bg-slate-200 h-40 w-full rounded-xl lg:h-57" />
