                                        ...
                                        <div className='relative h-100 overflow-hidden rounded-xl bg-slate-900'>
                                            ...
                                            <div className='absolute right-0 bottom-0 left-0 p-5 text-white lg:p-6'>
                                                <h3
                                                    ...
                                                    className='group-focus:text-primary-900 mb-3 -ml-1 rounded-sm px-1 text-xl leading-tight font-bold decoration-white underline-offset-4 transition-all duration-200 group-focus:bg-blue-50 group-focus:underline lg:text-2xl'>
                                                    {title}
                                                </h3>
                                                <CardContent
